...
const AppShell = React.forwardRef<HTMLDivElement, appShellProps>(
  (
    ...
    const [renderAsideData, setRenderAsideData] = React.useState<IAsideProps | null>(null)
        ...
        <div key={aside.title}>
          {aside.isOpenable && (
            ...
            >
              ...
              {loading ? <Group gap='xs' className="m-6">
                <Stack className='gap-2'>
                  <Skeleton animate='default' className='bg-gray-300 w-5/6 h-8' />
                  <Skeleton animate='default' className='bg-gray-300 w-72 h-8' />
                  <Skeleton animate='default' className='bg-gray-300 w-56 h-8' />
                  <Skeleton animate='default' className='bg-gray-300 w-5/6 h-8' />
                  <Skeleton animate='default' className='bg-gray-300 w-72 h-8' />
                  <Skeleton animate='default' className='bg-gray-300 w-5/6 h-8' />
                </Stack>
              </Group> : (aside.openedAsideComponent && aside.openedAsideComponent)}
        ...
        <div className="z-50">
          ...
          >
            <Stack justify="center" align="center" className="px-0">
              {Aside.map((aside) => (
                <ActionIcon
                  onClick={() => aside.isOpenable ? [setAsideOpened(!asideOpened), handleFilter(aside)] : aside.onClick ? aside.onClick() : null}
                  size="lg"
                  key={aside.title}
                  variant="ghost"
                  radius="none"
